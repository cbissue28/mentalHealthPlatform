...
// Query to select appointments for the student with dates that have not passed
...
mysqli_stmt_bind_param($stmt, "is", $studentID, $currentDate);
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Query to update the status of the appointment to 'cancelled'
    ...
    // Execute the prepared statement to update the appointment status
    mysqli_stmt_execute($updateStmt);

    // Close the prepared statement
    mysqli_stmt_close($updateStmt);

    // Refresh the page after user has cancelled appointment
    header("Location: studentManageAppointmentsPage.php");
    exit();
}
?>
          ...
          <div class="rounded mt-3 appointmentBox">
            ...
            <div class="text-center">
                <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                    ...
                    <button type="submit" class="btn infoButton" name="cancelAppointment">Cancel Appointment</button>
                </form>
            </div>
          </div>
    <?php } ?>
