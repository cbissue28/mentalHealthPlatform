      ...
      <div class="col-md-4">
          <div class="card  bg-white shadow p-5">
              <div class="mb-4 text-center">
                  <svg xmlns="http://www.w3.org/2000/svg" style="color: #5F9EA0;" width="75" height="75"
              ...
              <div class="text-center">
                  <h2>Appointment Successfully Requested</h2>
                  <a href="studentHomepage.php" class="btn infoButton">Back to Homepage</a>
              </div>
          </div>
      </div>
  </div>
